    ...
    if (selectedCategory === "inovasi") {
      const fetchInovasi = async () => {
        try {
          ...
          list = list.filter(item => item.dimensiId === "902aa703-6ca1-43aa-8203-91da409a0203");
      ...
      <section className="kunjungan-hero">
        ...
        <div className="kunjungan-content">
          ...
          <div className="smart-breadcrumb">
            ...
            <span className="dot">•</span>
            <span className="active">Smart Society</span>
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="berita-content">
                        <h2>Program Pemberdayaan Masyarakat Digital</h2>
                        <p>
